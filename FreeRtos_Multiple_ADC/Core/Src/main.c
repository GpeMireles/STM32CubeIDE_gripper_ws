...
/* Definitions for TaskADC1 */
osThreadId_t TaskADC1Handle;
const osThreadAttr_t TaskADC1_attributes = {
  .name = "TaskADC1",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for TaskADC2 */
osThreadId_t TaskADC2Handle;
const osThreadAttr_t TaskADC2_attributes = {
  .name = "TaskADC2",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
/* USER CODE BEGIN PV */
int adc1, adc2, task_adc1, task_adc2;
...
/* USER CODE BEGIN Header_StartTaskADC1 */
/**
  * @brief  Function implementing the TaskADC1 thread.
...
/* USER CODE BEGIN Header_StartTaskADC2 */
/**
* @brief Function implementing the TaskADC2 thread.
* @param argument: Not used
* @retval None
*/
