...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  button = HAL_GPIO_ReadPin(Limit_SW_GPIO_Port, Limit_SW_Pin);
	  if (paso == 0){
		  if (adc1 < 2125 && button != 1){
			  TIM2->CCR1 += 2;
		  }
		  else{
			  HAL_Delay(500);
